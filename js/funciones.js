function mostrarInputs() {
    ...
    switch (figura) 
    {
        ...
        case 'cuadrado':
            ...
            imageHTML = '<img src="./img/cuadrado1.png" alt="Cuadrado">';
            break;
    ...
    switch (figura) 
    {
        case 'circulo':
            ...
            if (radio > 0) 
            {
                ...
                resultado = 'El área es ' + areaCirculo.toFixed(2) + ' cm²';
            } 
        ...
        case 'cuadrado':
            ...
            if (lado > 0) 
            {
                ...
                resultado = 'El área es ' + areaCuadrado.toFixed(2) + ' cm²';
            } 
        ...
        case 'triangulo':
            ...
            if (base > 0 && altura > 0) 
            {
                ...
                resultado = 'El área es ' + areaTriangulo.toFixed(2) + ' cm²';
            } 
